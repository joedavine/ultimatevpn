...
<html lang="en">
  <head>
    ...
    <link href="css/style.min.css?<?php echo date('l jS \of F Y h:i:s A'); ?>" rel="stylesheet">

    <!-- Font Awesome -->
    <script src="https://use.fontawesome.com/6896f01bc4.js"></script>
    ...
    <div id="comparison">
      ...
      <h1 class="title text-center">About Us</h1>
        <div class="hero" style="padding-bottom: 30px;">
            <p>Find out what the Ultimate VPN do and what our mission is!</p>
        </div>
      
    </div>
      <div class="content-section">
        <h2>Who are we?</h2>
        <p>We're a group of technology enthusiast that are obessed with security and internet freedom. Be it watching a TV show from across the pond, to browsing websites without being monitored - we think everyone has the right to freedom. We set up UltimateVPN to help people make the best choice possible for their privacy, security and freedom needs.</p>
          
        <h2>How do we make money?</h2>
        <p>UltmateVPN partners with VPN providers to get free access to their service in order to write independent reviews. On top of this, we earn money for each user we eventually send their way. This doesn't mean we provide bias information however, we don't need to. Each company pays us, so everything is equal, giving us the opportunity to be fair across the board.</p>  
          
                          <div class="visit-button" style="text-align:center;margin-top:30px;">
                    <a href="/index" class="btn btn-cta">Compare Top VPNs Today <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
              </div>
      </div>
    <div class="testimonials container grey-bg" style="width: 100%;">
      <div>
        <div class="col-md-offset-2 col-md-8 text-center">
          ...
          <p class="location">Essex, United Kingdom</p>
                <div class="visit-button">
                    <a href="/index" class="btn btn-cta">Compare VPNs <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
              </div>
        </div>
      </div>
    </div> <!-- /container -->
