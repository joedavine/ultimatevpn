      ...
      <div class="container">
        <div class="comparison-table">
          <div class="row table-header text-center">
            <div class="col-md-1 col-ranking-header">
              <h3>Ranking</h3>
            </div>
            <div class="col-md-2 col-brand-header">
              <h3>Brand</h3>
            </div>
            ...
            <div class="col-md-2 col-rating-header">
              <h3>Our Rating</h3>
            </div>
            <div class="col-md-2 col-site-header">
              <h3>Visit site</h3>
            </div>
          </div>

          <div class="row">
            <div class="col-md-1 col-ranking">
              <ul>
                <li>1</li>
              </ul>
            </div>
